                    ...
                    <ol role="list" class="mx-auto flex max-w-2xl items-center space-x-2 px-4 sm:px-6 lg:max-w-7xl lg:px-8">
                        <li>
                            <div class="flex items-center">
                                <p href="" class="mr-2 text-sm font-medium text-gray-900">Publicaciones</p>
                        ...
                        <li class="text-sm">
                            <p href="#" aria-current="page" class="font-medium text-gray-500 hover:text-gray-600">{elemento.titulo}</p>
                        </li>
                    </ol>
                </nav>
